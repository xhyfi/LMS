...
// Check if the renewal request already exists
$sql_check = "SELECT * FROM LMS.renew WHERE IDNo = '$roll' AND BookId = '$id'";
...
if ($result_check->num_rows > 0) {
    ...
    // Insert the renewal request
    $sql = "INSERT INTO LMS.renew (IDNo, BookId) VALUES ('$roll', '$id')";
