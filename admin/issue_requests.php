...
if (isset($_SESSION['IDNo'])) {
    ...
    <head>
        ...
        <title>LMS - Issue Requests</title>
        <style>
            /* Main content area */
            .content {
                flex-grow: 1;
        ...
        <div class="content">
            <div class="table-container">
                ...
                <table class="table table-bordered mt-3">
                    ...
                    <tbody>
                        <?php
                        $sql = "SELECT u.Name, r.IDNo, r.BookId, b.Title, b.Availability 
                                FROM LMS.record r 
                                JOIN LMS.book b ON r.BookId = b.BookId 
                                JOIN user u ON r.IDNo = u.IDNo 
                                WHERE r.Date_of_Issue IS NULL 
                                ORDER BY r.Time";
                        ...
                        <tr>
                            ...
                            <td>
                                <center>
                                    <?php
                                    if ($avail > 0) {
                                        echo "<a href=\"accept.php?id1=".$bookid."&id2=".$idno."\" class=\"btn btn-success\">Accept</a>";
                                    }
                                    ?>
                                    <a href="reject.php?id1=<?php echo $bookid; ?>&id2=<?php echo $idno; ?>" class="btn btn-danger">Reject</a>
                                </center>
                            </td>
                        </tr>
                        <?php } ?>
